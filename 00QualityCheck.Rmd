...
If the Excel sheet contains mistakes in column names please correct. See in example 1.
If the Excel sheet contains initial explanatory rows, remove using [-(1:7),]. See example 2.
